...
export class VentasCampoComponent implements OnInit {
  ...
  // Motos por Tipo de Base: GLOBAL GO vs PROPIO (detalle, no por mes) — junto a Motos por Entidad.
  motosPorTipoBase: any[] = [];
  maxMontoMotoTipoBase = 1;
   ...
   *  no por entidad/financiadora — es la clasificación TipoBase de ventas_realzza. Se
   *  muestran TODAS las motos (incl. "SIN TIPO DE BASE") para que el total cuadre con
   *  Motos por Entidad y Motos por Tipo Producto, que están al lado. */
